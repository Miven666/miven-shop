...
public class CartServiceImpl implements CartService {
    ...
    public int addCart(long userId, long itemId, int num) {
        ...
        if (hexists) {
            ...
            if(json!=null){
                ...
                jedisClient.hset(CART_PRE + ":" + userId, itemId + "", JSON.toJSONString(cartProduct));
            }else {
                return 0;
            }
    ...
    public int checkAll(long userId,String checked) {
        ...
        for (String json : jsonList) {
            ...
            jedisClient.hset(CART_PRE + ":" + userId, cartProduct.getProductId() + "", JSON.toJSONString(cartProduct));
        }
