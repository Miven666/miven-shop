...
public interface JedisClient {
	 ...
	 */
	Optional<Long> expire(String key, int seconds);
	 ...
	 */
	Optional<Long> hset(String key, String field, String value);
	 ...
	 */
	Optional<Boolean> hexists(String key, String field);
	 ...
	 */
	Optional<List<String>> hvals(String key);
